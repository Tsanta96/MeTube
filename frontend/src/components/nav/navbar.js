...
class NavBar extends React.Component {
    ...
    if (this.state.sidenav) {
      return (
        <div className="sidenav-cont">
          ...
          <p onClick={this.renderProfile}>
            <i className="fas fa-home fa-fw"></i> Home
          </p>
          <p onClick={this.renderSubscriptions}>
            <i className="fas fa-photo-video fa-fw"></i> Subscriptions
          </p>
          <p onClick={this.renderTrending}>
      ...
      return (
        <div className="min-sidenav-cont">
          <div className="min-sidenav-icons">
            <i className="fas fa-home fa-fw" onClick={this.renderProfile}></i>
            <p>Home</p>
          </div>
          <div className="min-sidenav-icons">
            <i className="fas fa-fire fa-fw" onClick={this.renderTrending}></i>
            <p>Trending</p>
          </div>
          <div className="min-sidenav-icons">
            <i
              className="fas fa-photo-video fa-fw"
  ...
  render() {
    if (
      this.props.location.pathname === "/api/users/login" ||
      this.props.location.pathname === "/api/users/register"
    ) {
